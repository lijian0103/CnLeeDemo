 ...
 * @Version 1.0
 */
public class MultiStateButton3 extends AppCompatTextView {
    ...
    public MultiStateButton3(Context context) {
        this(context, null);
    }

    public MultiStateButton3(Context context, AttributeSet attrs) {
        this(context, attrs, 0);
    }

    public MultiStateButton3(Context context, AttributeSet attrs, int defStyleAttr) {
